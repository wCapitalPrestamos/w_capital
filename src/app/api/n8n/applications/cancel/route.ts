...
// cancelar su solicitud, tras la pregunta que le mandó el bot tras detectar
...
export async function POST(request: Request) {
  ...
  const note = body.original_message
    ? `Cliente canceló vía chatbot, tras confirmar con un clic — mensaje original: "${body.original_message}"`
